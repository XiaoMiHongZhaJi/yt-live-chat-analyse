...
CREATE TABLE yt_live_chat_analyse.live_info (
    ...
    timeline VARCHAR(1000) DEFAULT NULL COMMENT '时间线',
    ...
    live_status varchar(1) default '0' null comment '开播状态，0：直播预告，1：直播中，2：直播结束，',
    download_status varchar(1) default '0' null comment '弹幕下载状态，0：未下载，1：正在下载，2：已下载',
    PRIMARY KEY (id)
) ENGINE=INNODB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4;
